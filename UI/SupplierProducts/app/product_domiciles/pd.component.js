...
var productDComponent = (function () {
    function productDComponent() {
    }
    productDComponent.prototype.ngOnInit = function () { };
    return productDComponent;
}());
productDComponent = __decorate([
    core_1.Component({
        selector: 'productD',
...
exports.productDComponent = productDComponent;
